...
import (
	...
	"git.tencent.com/tke/tapp-controller/pkg/admission"
	...
	"git.tencent.com/tke/tapp-controller/pkg/version/verflag"
...
func addFlags(fs *pflag.FlagSet) {
	...
	fs.BoolVar(&deletePodAfterAppFinish, "delete-pod-after-app-finish", false, "If true, delete instance pod after app finishes, otherwise delete pod once pod finishes")
