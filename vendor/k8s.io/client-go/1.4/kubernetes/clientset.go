...
import (
	...
	v1alpha1gaia "k8s.io/client-go/1.4/kubernetes/typed/gaia/v1alpha1"
...
type Interface interface {
	...
	Gaia() v1alpha1gaia.GaiaInterface
}
...
// Gaia retrieves the GaiaClient
func (c *Clientset) Gaia() v1alpha1gaia.GaiaInterface {
	if c == nil {
		return nil
	}
	return c.GaiaClient
...
func NewForConfig(c *rest.Config) (*Clientset, error) {
	...
	clientset.GaiaClient, err = v1alpha1gaia.NewForConfig(&configShallowCopy)
	if err != nil {
		return nil, err
	}
...
func NewForConfigOrDie(c *rest.Config) *Clientset {
	...
	clientset.GaiaClient = v1alpha1gaia.NewForConfigOrDie(c)
...
func New(c *rest.RESTClient) *Clientset {
	...
	clientset.GaiaClient = v1alpha1gaia.New(c)
