...
func RegisterConversions(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedConversionFuncs(
		...
		Convert_v1_GaiaCloudVolumeSource_To_api_GaiaCloudVolumeSource,
		Convert_api_GaiaCloudVolumeSource_To_v1_GaiaCloudVolumeSource,
		...
		Convert_v1_NUMANode_To_api_NUMANode,
		Convert_api_NUMANode_To_v1_NUMANode,
...
func autoConvert_v1_GaiaCloudVolumeSource_To_api_GaiaCloudVolumeSource(in *GaiaCloudVolumeSource, out *api.GaiaCloudVolumeSource, s conversion.Scope) error {
	out.AllocateMode = in.AllocateMode
	out.VolumeSize = in.VolumeSize
	out.FSType = in.FSType
	return nil
}

func Convert_v1_GaiaCloudVolumeSource_To_api_GaiaCloudVolumeSource(in *GaiaCloudVolumeSource, out *api.GaiaCloudVolumeSource, s conversion.Scope) error {
	return autoConvert_v1_GaiaCloudVolumeSource_To_api_GaiaCloudVolumeSource(in, out, s)
}

func autoConvert_api_GaiaCloudVolumeSource_To_v1_GaiaCloudVolumeSource(in *api.GaiaCloudVolumeSource, out *GaiaCloudVolumeSource, s conversion.Scope) error {
	out.AllocateMode = in.AllocateMode
	out.VolumeSize = in.VolumeSize
	out.FSType = in.FSType
	return nil
...
func Convert_api_GaiaCloudVolumeSource_To_v1_GaiaCloudVolumeSource(in *api.GaiaCloudVolumeSource, out *GaiaCloudVolumeSource, s conversion.Scope) error {
	return autoConvert_api_GaiaCloudVolumeSource_To_v1_GaiaCloudVolumeSource(in, out, s)
}
...
func autoConvert_v1_LocalDiskSource_To_api_LocalDiskSource(in *LocalDiskSource, out *api.LocalDiskSource, s conversion.Scope) error {
	if err := api.Convert_resource_Quantity_To_resource_Quantity(&in.DiskSize, &out.DiskSize, s); err != nil {
		return err
	}
	return nil
}
...
func autoConvert_v1_NUMANode_To_api_NUMANode(in *NUMANode, out *api.NUMANode, s conversion.Scope) error {
	out.NUMANodeID = in.NUMANodeID
...
func Convert_v1_NUMANode_To_api_NUMANode(in *NUMANode, out *api.NUMANode, s conversion.Scope) error {
	return autoConvert_v1_NUMANode_To_api_NUMANode(in, out, s)
}

func autoConvert_api_NUMANode_To_v1_NUMANode(in *api.NUMANode, out *NUMANode, s conversion.Scope) error {
	out.NUMANodeID = in.NUMANodeID
	if in.Capacity != nil {
...
func Convert_api_NUMANode_To_v1_NUMANode(in *api.NUMANode, out *NUMANode, s conversion.Scope) error {
	return autoConvert_api_NUMANode_To_v1_NUMANode(in, out, s)
}
...
func autoConvert_v1_NodeStatus_To_api_NodeStatus(in *NodeStatus, out *api.NodeStatus, s conversion.Scope) error {
	...
	if in.LocalDisks != nil {
		...
		*out = make([]api.LocalDisk, len(*in))
		for i := range *in {
			if err := Convert_v1_LocalDisk_To_api_LocalDisk(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
	...
	if in.Topology != nil {
		...
		*out = make([]api.NUMANode, len(*in))
		for i := range *in {
			if err := Convert_v1_NUMANode_To_api_NUMANode(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
...
func autoConvert_api_NodeStatus_To_v1_NodeStatus(in *api.NodeStatus, out *NodeStatus, s conversion.Scope) error {
	...
	if in.LocalDisks != nil {
		...
		*out = make([]LocalDisk, len(*in))
		for i := range *in {
			if err := Convert_api_LocalDisk_To_v1_LocalDisk(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
	...
	if in.Topology != nil {
		...
		*out = make([]NUMANode, len(*in))
		for i := range *in {
			if err := Convert_api_NUMANode_To_v1_NUMANode(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
...
func autoConvert_v1_VolumeSource_To_api_VolumeSource(in *VolumeSource, out *api.VolumeSource, s conversion.Scope) error {
	...
	if in.GaiaCloudVolume != nil {
		in, out := &in.GaiaCloudVolume, &out.GaiaCloudVolume
		*out = new(api.GaiaCloudVolumeSource)
		if err := Convert_v1_GaiaCloudVolumeSource_To_api_GaiaCloudVolumeSource(*in, *out, s); err != nil {
			return err
		}
	} else {
		out.GaiaCloudVolume = nil
	}
	if in.GaiaRBD != nil {
		in, out := &in.GaiaRBD, &out.GaiaRBD
		*out = new(api.RBDVolumeSource)
		if err := Convert_v1_RBDVolumeSource_To_api_RBDVolumeSource(*in, *out, s); err != nil {
			return err
		}
	...
	if in.LocalDisk != nil {
		...
		*out = new(api.LocalDiskSource)
		if err := Convert_v1_LocalDiskSource_To_api_LocalDiskSource(*in, *out, s); err != nil {
			return err
		}
	} else {
		out.LocalDisk = nil
...
func autoConvert_api_VolumeSource_To_v1_VolumeSource(in *api.VolumeSource, out *VolumeSource, s conversion.Scope) error {
	...
	if in.GaiaCloudVolume != nil {
		in, out := &in.GaiaCloudVolume, &out.GaiaCloudVolume
		*out = new(GaiaCloudVolumeSource)
		if err := Convert_api_GaiaCloudVolumeSource_To_v1_GaiaCloudVolumeSource(*in, *out, s); err != nil {
			return err
		}
	} else {
		out.GaiaCloudVolume = nil
	...
	if in.LocalDisk != nil {
		...
		*out = new(LocalDiskSource)
		if err := Convert_api_LocalDiskSource_To_v1_LocalDiskSource(*in, *out, s); err != nil {
			return err
		}
	} else {
		out.LocalDisk = nil
