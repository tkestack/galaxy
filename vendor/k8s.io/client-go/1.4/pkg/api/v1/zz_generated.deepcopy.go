...
func RegisterDeepCopies(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedDeepCopyFuncs(
		...
		conversion.GeneratedDeepCopyFunc{Fn: DeepCopy_v1_GaiaCloudVolumeSource, InType: reflect.TypeOf(&GaiaCloudVolumeSource{})},
		...
		conversion.GeneratedDeepCopyFunc{Fn: DeepCopy_v1_NUMANode, InType: reflect.TypeOf(&NUMANode{})},
...
func DeepCopy_v1_GaiaCloudVolumeSource(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
...
func DeepCopy_v1_NUMANode(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		in := in.(*NUMANode)
		out := out.(*NUMANode)
...
func DeepCopy_v1_NodeStatus(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		...
		if in.Topology != nil {
			...
			*out = make([]NUMANode, len(*in))
			for i := range *in {
				if err := DeepCopy_v1_NUMANode(&(*in)[i], &(*out)[i], c); err != nil {
					return err
				}
			}
		} else {
...
func DeepCopy_v1_VolumeSource(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		...
		if in.LocalDisk != nil {
			...
			*out = new(LocalDiskSource)
			if err := DeepCopy_v1_LocalDiskSource(*in, *out, c); err != nil {
				return err
			}
		} else {
			out.LocalDisk = nil
