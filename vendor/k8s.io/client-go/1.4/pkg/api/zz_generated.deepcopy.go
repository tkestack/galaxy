...
func RegisterDeepCopies(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedDeepCopyFuncs(
		...
		conversion.GeneratedDeepCopyFunc{Fn: DeepCopy_api_GaiaCloudVolumeSource, InType: reflect.TypeOf(&GaiaCloudVolumeSource{})},
		...
		conversion.GeneratedDeepCopyFunc{Fn: DeepCopy_api_NUMANode, InType: reflect.TypeOf(&NUMANode{})},
...
func DeepCopy_api_GaiaCloudVolumeSource(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		in := in.(*GaiaCloudVolumeSource)
		out := out.(*GaiaCloudVolumeSource)
...
func DeepCopy_api_NUMANode(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		in := in.(*NUMANode)
		out := out.(*NUMANode)
...
func DeepCopy_api_NodeStatus(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		...
		if in.Topology != nil {
			...
			*out = make([]NUMANode, len(*in))
			for i := range *in {
				if err := DeepCopy_api_NUMANode(&(*in)[i], &(*out)[i], c); err != nil {
					return err
				}
			}
		} else {
...
func DeepCopy_api_VolumeSource(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		...
		if in.LocalDisk != nil {
			...
			*out = new(LocalDiskSource)
			if err := DeepCopy_api_LocalDiskSource(*in, *out, c); err != nil {
				return err
			}
		} else {
			out.LocalDisk = nil
