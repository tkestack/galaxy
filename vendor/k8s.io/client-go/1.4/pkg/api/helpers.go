...
var podComputeQuotaResources = sets.NewString(
	...
	string(ResourceLocalDisk),
	string(ResourceRequestsLocalDisk),
	string(ResourceEgress),
	string(ResourceRequestsEgress),
	string(ResourceIngress),
	string(ResourceRequestsIngress),
	string(ResourceNvidiaGPU),
	string(ResourceLimitsNvidiaGPU),
)
