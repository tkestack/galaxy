...
import (
	...
	"k8s.io/client-go/1.4/pkg/apis/gaia"
	"k8s.io/client-go/1.4/pkg/apis/gaia/v1alpha1"
	"k8s.io/client-go/1.4/pkg/runtime"
	"k8s.io/client-go/1.4/pkg/util/sets"
)

const importPrefix = "k8s.io/client-go/1.4/pkg/apis/gaia"
...
func init() {
	...
	if len(externalVersions) == 0 {
		glog.V(4).Infof("No version is registered for group %v", gaia.GroupName)
		return
	}
...
func interfacesFor(version unversioned.GroupVersion) (*meta.VersionInterfaces, error) {
	...
	default:
		g, _ := registered.Group(gaia.GroupName)
...
func addVersionsToScheme(externalVersions ...unversioned.GroupVersion) {
	...
	if err := gaia.AddToScheme(api.Scheme); err != nil {
