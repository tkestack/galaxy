...
type TAppSpec struct {
	...
	TemplatePool map[string]api.PodTemplateSpec `json:"templatePool,omitempty"`
...
var InstanceStatusAll []InstanceStatus = []InstanceStatus{INSTANCE_NOTCREATED, INSTANCE_PENDING, INSTANCE_RUNNING, INSTANCE_FAILED, INSTANCE_KILLING, INSTANCE_SUCC, INSTANCE_KILLED}
