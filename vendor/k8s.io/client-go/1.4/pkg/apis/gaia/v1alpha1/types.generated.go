				...
				if yyq33[3] {
					if x.TemplatePool == nil {
						...
						if false {
							...
							h.encMapstringv1_PodTemplateSpec((map[string]pkg2_v1.PodTemplateSpec)(x.TemplatePool), e)
						}
					}
				} else {
					r.EncodeNil()
		...
		case "templatePool":
			if r.TryDecodeAsNil() {
				...
				if false {
					...
					h.decMapstringv1_PodTemplateSpec((*map[string]pkg2_v1.PodTemplateSpec)(yyv59), d)
				}
			}
		case "statuses":
			if r.TryDecodeAsNil() {
...
func (x *TAppSpec) codecDecodeSelfFromArray(l int, d *codec1978.Decoder) {
	...
	if r.TryDecodeAsNil() {
		...
		if false {
			...
			h.decMapstringv1_PodTemplateSpec((*map[string]pkg2_v1.PodTemplateSpec)(yyv70), d)
		}
	}
	yyj65++
	if yyhl65 {
...
func (x codecSelfer1234) encMapstringv1_PodTemplateSpec(v map[string]pkg2_v1.PodTemplateSpec, e *codec1978.Encoder) {
	var h codecSelfer1234
	z, r := codec1978.GenHelperEncoder(e)
	_, _, _ = h, z, r
...
func (x codecSelfer1234) decMapstringv1_PodTemplateSpec(v *map[string]pkg2_v1.PodTemplateSpec, d *codec1978.Decoder) {
	var h codecSelfer1234
	z, r := codec1978.GenHelperDecoder(d)
	_, _, _ = h, z, r
	...
	if yyv148 == nil {
		yyrl148, _ := z.DecInferLen(yyl148, yybh148.MaxInitLen, 488)
		yyv148 = make(map[string]pkg2_v1.PodTemplateSpec, yyrl148)
		*v = yyv148
	}
	var yymk148 string
	var yymv148 pkg2_v1.PodTemplateSpec
	var yymg148 bool
	...
	if yyl148 > 0 {
		for yyj148 := 0; yyj148 < yyl148; yyj148++ {
			...
			if yymg148 {
				...
				yymv148 = pkg2_v1.PodTemplateSpec{}
			}
			z.DecSendContainerState(codecSelfer_containerMapValue1234)
			if r.TryDecodeAsNil() {
				yymv148 = pkg2_v1.PodTemplateSpec{}
...
func (x codecSelfer1234) decSliceTApp(v *[]TApp, d *codec1978.Decoder) {
	...
	if yyl162 == 0 {
		...
		if yyl162 > cap(yyv162) {
			...
			yyv2162 := yyv162
			yyrl162, yyrt162 = z.DecInferLen(yyl162, z.DecBasicHandle().MaxInitLen, 816)
			if yyrt162 {
