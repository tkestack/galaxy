...
func init() {
	proto.RegisterType((*StorageClass)(nil), "k8s.io.client-go.1.4.pkg.apis.storage.v1beta1.StorageClass")
	proto.RegisterType((*StorageClassList)(nil), "k8s.io.client-go.1.4.pkg.apis.storage.v1beta1.StorageClassList")
}
