...
type TAppLister interface {
	...
	List(selector labels.Selector) (ret []*v1alpha1.TApp, err error)
...
// List lists all TApps in the indexer.
func (s *tAppLister) List(selector labels.Selector) (ret []*v1alpha1.TApp, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1alpha1.TApp))
	})
	return ret, err
}
...
// List lists all TApps in the indexer for a given namespace.
func (s tAppNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.TApp, err error) {
...
// Get retrieves the TApp from the indexer for a given namespace and name.
func (s tAppNamespaceLister) Get(name string) (*v1alpha1.TApp, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("tapp"), name)
	}
	return obj.(*v1alpha1.TApp), nil
}
