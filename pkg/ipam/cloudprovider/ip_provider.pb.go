...
func (*AssignIPRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_ip_provider_939cb44ca3de6317, []int{0}
}
...
func (*AssignIPReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_ip_provider_939cb44ca3de6317, []int{1}
}
...
func (*UnAssignIPRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_ip_provider_939cb44ca3de6317, []int{2}
}
...
func (*UnAssignIPReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_ip_provider_939cb44ca3de6317, []int{3}
}
...
func init() {
	proto.RegisterType((*AssignIPRequest)(nil), "cloudprovider.AssignIPRequest")
	proto.RegisterType((*AssignIPReply)(nil), "cloudprovider.AssignIPReply")
	proto.RegisterType((*UnAssignIPRequest)(nil), "cloudprovider.UnAssignIPRequest")
	proto.RegisterType((*UnAssignIPReply)(nil), "cloudprovider.UnAssignIPReply")
}
...
func (c *iPProviderServiceClient) AssignIP(ctx context.Context, in *AssignIPRequest, opts ...grpc.CallOption) (*AssignIPReply, error) {
	...
	err := c.cc.Invoke(ctx, "/cloudprovider.IPProviderService/AssignIP", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *iPProviderServiceClient) UnAssignIP(ctx context.Context, in *UnAssignIPRequest, opts ...grpc.CallOption) (*UnAssignIPReply, error) {
	...
	err := c.cc.Invoke(ctx, "/cloudprovider.IPProviderService/UnAssignIP", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _IPProviderService_AssignIP_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cloudprovider.IPProviderService/AssignIP",
	}
...
func _IPProviderService_UnAssignIP_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cloudprovider.IPProviderService/UnAssignIP",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _IPProviderService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "cloudprovider.IPProviderService",
...
func init() { proto.RegisterFile("ip_provider.proto", fileDescriptor_ip_provider_939cb44ca3de6317) }

var fileDescriptor_ip_provider_939cb44ca3de6317 = []byte{
	// 240 bytes of a gzipped FileDescriptorProto
	,
}
